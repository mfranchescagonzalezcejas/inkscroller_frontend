...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsCleanupFailedMessage.
  ///
  /// In en, this message translates to:
  /// **'Error during cleanup'**
  String get settingsCleanupFailedMessage;
  ...
  /// No description provided for @settingsAccountEmailLabel.
  ///
  /// In en, this message translates to:
  /// **'Email'**
  String get settingsAccountEmailLabel;

  /// No description provided for @settingsAccountDeleteButton.
  ///
  /// In en, this message translates to:
  /// **'Delete account'**
  ...
  /// No description provided for @settingsDeleteDialogRecoveryMessage.
  ///
  /// In en, this message translates to:
  /// **'The deletion is incomplete. You need to finish the data cleanup.'**
  String get settingsDeleteDialogRecoveryMessage;

  /// No description provided for @settingsDeleteDialogWarning.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @settingsDeleteDialogConfirmHint.
  ///
  /// In en, this message translates to:
  /// **'Type DELETE to confirm:'**
  String get settingsDeleteDialogConfirmHint;

  /// No description provided for @settingsDeleteDialogPasswordHint.
  ///
  /// In en, this message translates to:
  /// **'Enter your password to retry:'**
  String get settingsDeleteDialogPasswordHint;

  /// No description provided for @settingsDeleteDialogPasswordFieldHint.
  ///
  /// In en, this message translates to:
  /// **'Password'**
  String get settingsDeleteDialogPasswordFieldHint;

  /// No description provided for @settingsDeleteDialogDeleteButton.
  ///
  /// In en, this message translates to:
  /// **'Delete'**
  ...
  /// In en, this message translates to:
  /// **'Cancel'**
  String get settingsDeleteDialogCancelButton;
