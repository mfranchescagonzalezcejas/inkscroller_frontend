...
- [`design/designApp.pen`](../design/designApp.pen) — active editable Pencil source of truth
...
1. Use `design/DESIGN.md` + `design/designApp.pen` as canonical design sources
