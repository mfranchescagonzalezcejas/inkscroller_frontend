...
[![Tests](https://img.shields.io/badge/tests-197%20exitosos-0d9488?logo=github)](https://github.com/mfranchescagonzalezcejas/inkscroller_frontend/actions)
...
```bash
fvm flutter analyze
fvm flutter test    # 197 tests — todos verificados ✅
```
